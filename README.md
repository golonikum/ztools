...
Клонирование всех проектов в указанную директорию. Происходит параллельно, поэтому намного быстрее (около 5 минут), чем руками. Удобно при переезде на новый компьютер.
